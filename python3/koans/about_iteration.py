...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        #For a list: takes first item in a list, then performs a function on it for each subsequent item
        #third argument for result 2 has unknown function. perhaps 2 squares, 3 cubes?
